...
/*
* Write here all the queries needed in ALL BACKOFFICE's pages.
* Write here all the variables needed in ALL BACKOFFICE's pages.
*/
...
if ( !empty($session->user_id) ) {
	...
	$user_query = "SELECT `_id`, 	`login`, 	`name`, 	`surname`, `initials`,	 	`email`, 	`password`,	`isAdmin`, 	`birthDate`, 	date_format(registrationDate, '" . DATE_FORMAT_DATETIME . "') as registrationDate,	address, 	cap, 	city FROM users WHERE _id = {$session->user_id}";
